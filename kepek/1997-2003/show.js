function show(newwin, set, i)
{
	...
	var d = w.document;
	var url_show_js = "http://www.kfki.hu/~cspeter/kepek/1997-2003/show.js";
	d.open();
	d.write('<html>\n<head>\n');
	d.write('<meta HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=utf-8">\n');
	d.write('<title>'+titles[set][i]+'</title>\n');
	d.write('</head>\n');
	d.write('<body BGCOLOR="#202040" TEXT="#c0c0ff">\n');
...
//	d.write('<script LANGUAGE="JavaScript1.1" SRC="show.js"></script>');
	d.write('<script LANGUAGE="JavaScript1.1" SRC="');
	d.write(url_show_js);
	d.write('"></script>');
	d.write('<center>\n');
	...
	if(i > 0) {
		...
		d.write('<font COLOR="#202040">&lt;&lt;&lt;</font>\n');
	}
	d.write('<font COLOR="#333333">'+
